// Hyperspeed (React Bits) — mantido em JS por ser código de terceiros cheio de
// shaders GLSL; o wrapper TypeScript fica em hyperspeed-background.tsx.
// Alterações em relação ao original: cores padrão na paleta do inDash, CSS
// escopado (o original estilizava `canvas` globalmente) e classe no lugar do id.
"use client";
...
const DEFAULT_EFFECT_OPTIONS = {
  ...
  // Paleta do inDash: asfalto no azul-noite do tema e faróis nos azuis da marca
  colors: {
    roadColor: 0x0a0d14,
...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  return <div className="hyperspeed-root" ref={hyperspeed} aria-hidden="true" />;
};
