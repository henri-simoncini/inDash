// LiquidEther (React Bits) — mantido em JS por ser código de terceiros.
//
// Alteração em relação ao original: a textura da paleta é liberada na
// limpeza. O original só descarta o renderer, então cada remontagem (o
// StrictMode monta duas vezes em desenvolvimento) deixava uma DataTexture
// para trás.
"use client";
